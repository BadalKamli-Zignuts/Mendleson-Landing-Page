  ...
  return (
    <div className="min-h-screen text-black">
      <img
        src={Asset1}
        alt=""
        className="w-1/6 lg:w-1/12 absolute top-0 left-0 -z-10"
      />
      <img
        src={Asset2}
        alt="R"
      ...
      <img
        src={Asset3}
        alt=""
        className="w-1/3 absolute bottom-0 -left-7 -z-10 md:w-1/4 lg:w-1/5 xl:w-[12%]"
      />
      <img
        src={Asset4}
        alt="R"
      ...
      <img
        ...
        alt="R"
        className="w-1/2 absolute bottom-0 lg:w-[40%] lg:left-20 xl:w-1/3 xl:left-20"
      />
      <img
        src={Graphics12}
        alt="R"
      ...
      <div className="absolute top-1/3 w-1/2 left-1/4 space-y-4 -z-10 md:top-1/4 md:w-1/3 md:left-1/2 lg:left-[55%]
      lg:w-[25%] xl:left-[60%] xl:w-[30%]">
        <h1 className="text-3xl rubik-bold md:text-4xl leading-6 lg:text-5xl lg:leading-tight lg:font-medium ">
          Mendleson Communication and Engagement
        </h1>
        <p className="text-lg leading-4 rubik-thin md:text-xl md:rubik-medium">
