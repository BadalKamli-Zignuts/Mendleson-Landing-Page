...
const Services = () => {
  return (
    <div className="mt-40 min-h-screen text-black md:mt-60 lg:mt-32">
      {/* Section Title */}
      <h2 className="text-4xl rubik-medium mb-4 lg:text-5xl lg:rubik-medium lg:flex lg:flex-col lg:justify-center lg:items-center">
        SERVICES
        <img src={Group31Image} className="py-2 w-[54%] md:w-1/3 xl:w-[21%] 2xl:w-[15%]" alt="" />
      </h2>
      ...
      <div className="flex flex-col lg:flex-col lg:items-center">
        ...
        {/* Training and Mentoring Section */}
        <div className="w-full">
          <ServiceContent
